          ...
          <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
                Track procurement actions against installation need dates,
                submittal holds, vendor commitments, and release readiness.
              </p>
            </div>
          ...
          <aside className="flex flex-col gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Items most likely to block crews
                </CardDescription>
              </CardHeader>
