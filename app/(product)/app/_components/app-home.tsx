...
export const AppHome = () => (
  <main className="min-h-screen bg-[#eef1f4] text-[#101820]">
    ...
    <div className="mx-auto grid max-w-7xl gap-6 px-6 py-6 md:px-10 lg:grid-cols-[1fr_22rem]">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {readinessItems.map((item) => (
            <div
              ...
              key={item.label}
            >
              <p className="text-sm font-medium text-[#637083]">{item.label}</p>
      ...
      <aside className="space-y-6">
        <section className="border border-[#c9d0d8] bg-white p-5">
          ...
          <ol className="mt-5 space-y-4 text-sm text-[#334155]">
            <li className="flex gap-3">
              <span className="font-mono font-semibold text-[#101820]">01</span>
              Resolve long-lead switchgear submittal comments.
            </li>
            <li className="flex gap-3">
              <span className="font-mono font-semibold text-[#101820]">02</span>
              Release prefab package for the MCC room.
            </li>
            <li className="flex gap-3">
              <span className="font-mono font-semibold text-[#101820]">03</span>
